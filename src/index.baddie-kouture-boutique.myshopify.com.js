...
import configurations from "./config/baddie-kouture-boutique.myshopify.com.json";
...
const shop = "baddie-kouture-boutique.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#shopify-section-cart-template > section > div > div > form > footer > div.Cart__Recap > span.Cart__Total.Heading.u-h6 > span",
  ...
  chekoutBtnSelector:
    "#shopify-section-cart-template > section > div > div > form > footer > div.Cart__Recap > button",
