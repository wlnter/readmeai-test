...
import configurations from "./config/950ce7.myshopify.com.json";
...
const shop = "950ce7.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".bcpo-cart-original-total",
  dynamicSubtotalSelector: ".kaktusc-cart__total-price",
  chekoutBtnSelector: "#checkout",
  dynamicCheckoutBtnSelector: ".kaktusc-cart__checkout",
