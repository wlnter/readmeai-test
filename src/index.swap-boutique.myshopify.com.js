...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/swap-boutique.myshopify.com.js";
import renderModal from "./component/modal/swap-boutique.myshopify.com.js";
import renderPdpBanner from "./component/pdp-banner";
import configurations from "./config/swap-boutique.myshopify.com.json";
import { productType } from "./core/constant";

store.configs = configurations;

const subtotalSelector = ".under-cart .align-right .h2 .subtotal";
// const dynamicSubtotalSelector = ".Cart__Total .money";
const chekoutBtnSelector = ".under-cart .checkout-btn";
...
(async () => {
  const shop = "swap-boutique.myshopify.com";
