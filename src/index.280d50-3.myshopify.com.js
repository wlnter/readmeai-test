...
import configurations from "./config/280d50-3.myshopify.com.json";
...
const shop = "280d50-3.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "#cart-subtotal strong",
  dynamicSubtotalSelector: "#cart-modal-form-footer .product-price",
  chekoutBtnSelector: "#checkout-btn",
  dynamicCheckoutBtnSelector: ".button-buy",
