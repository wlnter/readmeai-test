...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/stumbul.myshopify.com.js";
import renderModal from "./component/modal";
import configurations from "./config/stumbul.myshopify.com.json";
import renderPdpBanner from "./component/pdp-banner";
import { productType } from "./core/constant";

store.configs = configurations;

const shop = "stumbul.myshopify.com";
const subtotalSelector = ".checkout-sidebar .cart-subtotal .float-end";
const dynamicSubtotalSelector = ".mini-cart-bottom .cart-subtotal .ms-auto";
const chekoutBtnSelector = "#MainContent #main-cart-items .cart__ctas";
const dynamicCheckoutBtnSelector = "#form-minicart button[name=checkout]";
