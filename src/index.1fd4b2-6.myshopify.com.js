...
import configurations from "./config/1fd4b2-6.myshopify.com.json";
...
const shop = "1fd4b2-6.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
  ...
  dynamicSubtotalSelector:
    "#CartDrawer > div.drawer__inner.gradient.color-background-1 > div.drawer__footer > div.cart-drawer__footer > div.totals > p > span",
