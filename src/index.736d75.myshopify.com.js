...
import configurations from "./config/736d75.myshopify.com.json";
...
const shop = "736d75.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "#main-cart-footer .cart__blocks .totals__total-value",
  dynamicSubtotalSelector:
    ".qsc2-drawer-footer__summary-subtotal div:last-child",
  chekoutBtnSelector: "#checkout",
  dynamicCheckoutBtnSelector: ".qsc2-checkout-button",
