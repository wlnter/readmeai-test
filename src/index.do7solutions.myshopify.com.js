...
import configurations from "./config/do7solutions.myshopify.com.json";
...
import "./component/cart-widget/do7solutions.myshopify.com.css";
...
const shop = "do7solutions.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "div.cart__footer > div > div > div.cart-subtotal > span.cart-subtotal__price > span",
  dynamicSubtotalSelector: "",
  chekoutBtnSelector: ".cart__footer .fs-checkout-btn",
