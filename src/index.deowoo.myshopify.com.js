...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/deowoo.myshopify.com.js";
import renderModal from "./component/modal";
import renderPdpBanner from "./component/pdp-banner";
import configurations from "./config/deowoo.myshopify.com.json";
import { productType } from "./core/constant";

store.configs = configurations;

const shop = "deowoo.myshopify.com";
const subtotalSelector =
  "#cartform .checkout-subtotal-container__dynamic .theme-money";
const dynamicSubtotalSelector = "";
const chekoutBtnSelector = "#update-cart";
