...
import configurations from "./config/fromtheheartconsignment.myshopify.com.json";
...
const shop = "fromtheheartconsignment.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".cart-info-container .cart__subtotal",
...
const changeSubtotal = (
  ...
  if (
    ...
    element.replaceWith(`${currencySymbol}${amount}`);
  }
};
