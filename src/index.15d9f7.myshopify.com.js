...
import configurations from "./config/15d9f7.myshopify.com.json";
...
const subtotalSelector = "#MainContent [data-cart-final]";
const dynamicSubtotalSelector = "#drawer-cart [data-cart-final]";
const chekoutBtnSelector = "#MainContent [name=checkout]";
const dynamicCheckoutBtnSelector = "#drawer-cart [name=checkout]";
