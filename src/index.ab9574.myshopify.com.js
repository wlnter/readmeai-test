...
import configurations from "./config/ab9574.myshopify.com.json";
...
const shop = "ab9574.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#jas-content > div.jas-container > div > div > div.shopify.jas_cart_page > form > div > div.cart_totals.calculated_shipping > table > tbody > tr.order-total > td > strong",
  dynamicSubtotalSelector: "#cart__popup_total",
  chekoutBtnSelector: ".checkout-button",
  dynamicCheckoutBtnSelector:
    "#content_cart__popup_nt > div.cart__popup_content.pr.shopify.form_jas_agree > div.flex.between-xs.tc.cart__popup-action > a.class_none_bundle.checkout-button.button.mt__20",
