...
import configurations from "./config/aikedirectshop.myshopify.com.json";
...
import "./component/cart-widget/aikedirectshop.myshopify.com.css";
...
const shop = "aikedirectshop.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "",
  dynamicSubtotalSelector:
    "#mu-checkout-container > div.mu-subtotal.mu-pb-3.mu-flex.mu-items-center.mu-font-bold.mu-info-item > span.notranslate > span",
  chekoutBtnSelector: "",
