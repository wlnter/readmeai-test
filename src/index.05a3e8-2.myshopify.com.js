...
import configurations from "./config/05a3e8-2.myshopify.com.json";
...
const shop = "05a3e8-2.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".cart__footer .totals__total-value",
  dynamicSubtotalSelector: ".cart-drawer__footer .totals__total-value",
