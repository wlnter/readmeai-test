...
import configurations from "./config/maija-0618.myshopify.com.json";
...
const shop = "maija-0618.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "",
  dynamicSubtotalSelector:
    "#Cart-Drawer > div > div.side-panel-footer > div.cart-drawer-footer > div > a.button.full.checkout > span",
  chekoutBtnSelector: "",
  dynamicCheckoutBtnSelector:
    "#Cart-Drawer > div > div.side-panel-footer > div.cart-drawer-footer > div > a.button.full.checkout",
