...
import configurations from "./config/0d5553.myshopify.com.json";
...
const shop = "0d5553.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
...
const changeSubtotal = (
  ...
  if (
    ...
    const originalPriceEle = element.querySelector(".t4s-cart__originalPrice");
    const discountPriceEle = element.querySelector(".t4s-cart__discountPrice");
    const totalPriceEle = element.querySelector(".t4s-cart__totalPrice");
