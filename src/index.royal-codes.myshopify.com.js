...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/royal-codes.myshopify.com.js";
import renderModal from "./component/modal";
import renderPdpBanner from "./component/pdp-banner";
import configurations from "./config/royal-codes.myshopify.com.json";
import { productType } from "./core/constant";

store.configs = configurations;

const subtotalSelector = ".Cart__Checkout .money";
const dynamicSubtotalSelector = ".Cart__Total .money";
const chekoutBtnSelector = ".Cart__Checkout";
...
(async () => {
  const shop = "royal-codes.myshopify.com";
