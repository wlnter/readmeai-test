...
import configurations from "./config/c9ba7b.myshopify.com.json";
...
const shop = "c9ba7b.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "#MainContent [data-subtotal]",
  dynamicSubtotalSelector: "#CartDrawer [data-subtotal]",
  chekoutBtnSelector: "#MainContent [name=checkout]",
  dynamicCheckoutBtnSelector: "#CartDrawer [name=checkout]",
