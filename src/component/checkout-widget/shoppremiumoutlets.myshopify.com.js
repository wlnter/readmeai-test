...
import "./index.css";
import "./shoppremiumoutlets.myshopify.com.css";
import seelLetters from "../../asset/seel-letters.svg";
...
export const flatten = (widget, type) => {
  ...
  // UI定制 start
  let seelLogo = document.createElement("img");
  seelLogo.setAttribute("class", "seel_widget--title_line--logo");
  seelLogo.setAttribute("src", seelLetters);
  widgetName.insertAdjacentElement("beforeend", seelLogo);
  // UI定制 end
