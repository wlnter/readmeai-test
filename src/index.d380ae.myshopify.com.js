...
import configurations from "./config/d380ae.myshopify.com.json";
...
const subtotalSelector = ".card__section .cart-recap__price-line-price";
const dynamicSubtotalSelector = ".mini-cart__recap-price-line span:last-child";
const chekoutBtnSelector = ".card__section [name=checkout]";
const dynamicCheckoutBtnSelector = ".mini-cart [name=checkout]";
const dynamicUpdateSection = ".mini-cart__line-item-list";
const updateSection = ".line-item-table";
