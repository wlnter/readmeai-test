...
import configurations from "./config/99750b-2.myshopify.com.json";
...
import "./component/cart-widget/99750b-2.myshopify.com.css";
...
const shop = "99750b-2.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#cartForm > div > div.grid__item.medium--six-twelfths.large--five-twelfths.cart__right-item > div > div.card-footer > button > span > span.cart-cost > span",
  dynamicSubtotalSelector:
    "#ajaxCartForm > div.drawer__footer > button > span > span.cart-cost > span",
