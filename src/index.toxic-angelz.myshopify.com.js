...
import configurations from "./config/toxic-angelz.myshopify.com.json";
...
const shop = "toxic-angelz.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "#MainContent .totals__subtotal-value span:last-child",
  dynamicSubtotalSelector: "",
  chekoutBtnSelector: "#MainContent [name=checkout]",
  dynamicCheckoutBtnSelector: "#cart-notification [name=checkout]",
