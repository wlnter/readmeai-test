...
import configurations from "./config/taanaa-jewelry.myshopify.com.json";
...
const shop = "taanaa-jewelry.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".cart-footer .cart-recap .text-lg:last-child",
  dynamicSubtotalSelector: "#cart-drawer .cart-drawer__button-price",
  chekoutBtnSelector: ".cart-footer [name=checkout]",
