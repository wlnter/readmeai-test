...
import configurations from "./config/51aad1.myshopify.com.json";
...
const subtotalSelector = ".cart-footer .text-lg:last-child";
const dynamicSubtotalSelector = "#cart-drawer .cart-drawer__button-price";
const chekoutBtnSelector = ".cart-footer [name=checkout]";
