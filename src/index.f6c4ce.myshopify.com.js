...
import configurations from "./config/f6c4ce.myshopify.com.json";
...
const shop = "f6c4ce.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#shopify-section-template--21666275885354__main > div > div > div > form > div > div > div > div.h-stack.justify-start.gap-2 > span:nth-child(2) > span",
  dynamicSubtotalSelector: ".cart-drawer__button-price .ht-money",
  chekoutBtnSelector: "#main [name=checkout]",
  dynamicCheckoutBtnSelector: "#cart-drawer [name=checkout]",
  dynamicUpdateSection: ".cart-drawer__items",
  updateSection: "",
};
