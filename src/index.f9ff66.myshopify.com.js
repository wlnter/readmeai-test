...
import configurations from "./config/f9ff66.myshopify.com.json";
...
const shop = "f9ff66.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".cart__total-container .h6:last-child",
  dynamicSubtotalSelector:
    "#mini-cart .mini-cart__drawer-footer [name=checkout]",
...
const changeSubtotal = (
  ...
  if (
    ...
    let element = document.querySelector(dynamicSubtotalSelector).childNodes;
    element = element[element.length - 1];
    element.replaceWith(`${currencySymbol}${amount} ${currency}`);
  }
};
