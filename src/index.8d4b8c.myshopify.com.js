...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/8d4b8c.myshopify.com.js";
import renderModal from "./component/modal";
import renderPdpBanner from "./component/pdp-banner";
import configurations from "./config/8d4b8c.myshopify.com.json";
import { productType } from "./core/constant";

store.configs = configurations;

const subtotalSelector = "#MainContent .cart__summary-total span:nth-child(2)";
const dynamicSubtotalSelector = ".cart-drawer__summary-total span:nth-child(2)";
const chekoutBtnSelector = ".cart__summary-actions [name=checkout]";
...
(async () => {
  const shop = "8d4b8c.myshopify.com";
