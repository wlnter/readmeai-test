...
import configurations from "./config/has-no-bounds.myshopify.com.json";
import renderModal from "./component/modal";
import renderPdpBanner from "./component/pdp-banner";
//import configurations from "./config/index.json";
import { productType } from "./core/constant";
import "./component/cart-widget/has-no-bounds.myshopify.com.css";
...
const subtotalSelector = "#MainContent .sf-cart-subtotal__price .money";
const dynamicSubtotalSelector =
  "#cart-drawer-container .scd__subtotal-price .money";
const chekoutBtnSelector =
  "#MainContent .sf-cart__submit-controls [name=checkout]";
const dynamicCheckoutBtnSelector = "#cart-drawer-container [name=checkout]";
