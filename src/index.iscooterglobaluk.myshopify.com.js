...
import configurations from "./config/iscooterglobaluk.myshopify.com.json";
...
const shop = "iscooterglobaluk.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".cart__footer [data-subtotal]",
