...
import configurations from "./config/eb7038-2.myshopify.com.json";
...
import "./component/cart-widget/eb7038-2.myshopify.com.css";
...
const shop = "eb7038-2.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "#main-cart-footer .totals__total-value",
  dynamicSubtotalSelector: ".drawer__footer .totals__total-value",
  chekoutBtnSelector: "#main-cart-footer [name=checkout]",
  dynamicCheckoutBtnSelector: ".drawer__footer [name=checkout]",
  dynamicUpdateSection: "#CartDrawer-Form",
