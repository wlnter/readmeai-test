...
import configurations from "./config/dzees.myshopify.com.json";
...
const shop = "dzees.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#MainContent > div > div > div > form > div:nth-child(4) > div > div > div:nth-child(2) > div:nth-child(2) > p",
  dynamicSubtotalSelector:
    "#CartContainer > form > div.drawer__footer.drawer__footer--fixed.appear-animation.appear-delay-7 > div:nth-child(2) > div.grid__item.one-half.text-right > p",
  chekoutBtnSelector: "#MainContent [name=checkout]",
