...
import configurations from "./config/c7ea4e-2.myshopify.com.json";
...
const shop = "c7ea4e-2.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector:
    "#main-cart-footer > div > div.cartTotal > div.totals.cart_total.mb15.fl.f-jcsb.ttu > span:nth-child(2)",
  dynamicSubtotalSelector:
    "#CartDrawer > div.drawer__inner.block-cart.fl.f-col > div.drawer__footer > div.cart_btns > div.cart_total.fl.f-jcsb > span:nth-child(2)",
  chekoutBtnSelector: "#checkout",
  dynamicCheckoutBtnSelector: "#CartDrawer-Checkout",
  dynamicUpdateSection: ".drawer__cart-items-wrapper",
