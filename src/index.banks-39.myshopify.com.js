...
import embedWidget, {
  flatten as repaint,
} from "./component/cart-widget/banks-39.myshopify.com.js";
import renderModal from "./component/modal";
import renderPdpBanner from "./component/pdp-banner";
import configurations from "./config/banks-39.myshopify.com.json";
import { productType } from "./core/constant";

store.configs = configurations;

const shop = "banks-39.myshopify.com";
const subtotalSelector = ".Cart__Total span";
const dynamicSubtotalSelector = ".Cart__SubtotalValue";
const chekoutBtnSelector = ".Cart__Footer .Cart__Checkout";
const dynamicCheckoutBtnSelector = "#sidebar-cart .Cart__Checkout";
