...
import configurations from "./config/thesouthofr.myshopify.com.json";
...
const shop = "thesouthofr.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: "div.right-col > div.groued-info > div.total > span.price",
  dynamicSubtotalSelector:
    "#dropdown-cart > div.has-items > div.summary > div.total > span.price",
  chekoutBtnSelector:
    "div.right-col > div.grouped-bottom > div.btn-actions > input",
  dynamicCheckoutBtnSelector:
    "#dropdown-cart > div.has-items > div.actions > button",
