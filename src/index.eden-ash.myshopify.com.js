...
import configurations from "./config/eden-ash.myshopify.com.json";
...
const shop = "eden-ash.myshopify.com";
const option = {
  atcButtonSelector: "",
  quantitySelector: "",
  subtotalSelector: ".Cart__Footer .Cart__Total span",
  dynamicSubtotalSelector: "[name=checkout] span:last-child",
  chekoutBtnSelector: ".Cart__Footer [name=checkout]",
  dynamicCheckoutBtnSelector: ".Drawer__Footer [name=checkout]",
  dynamicUpdateSection: "",
  updateSection: ".Cart__ItemList",
};
